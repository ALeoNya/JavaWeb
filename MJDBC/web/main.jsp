...
<%--    <a href="/queryselfdata1">查看个人信息页面</a>--%>
    ...
    <div id="login-box" style="left: 600px;bottom: 230px;">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <span class="login100-form-title p-b-49">管理员控制台</span>
            <span >欢迎您：${userName} 管理员先生/女士，您可以在这里修改所有员工信息</span>
            <hr>
            <a href="/queryallstu"><button>查看所有员工的信息页面</button></a>
